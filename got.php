...
<div id="logo">
	<a href="fandom.php">
		<img src="res/unified.jpg" width="100%">
	</a>
</div>
...
<div id="sidebar">
	<ul>
		...
		<td>&nbsp;Men</td></tr></table></a></li>

		<li><a href="#acc"><table><tr><td><img src="res/icons/accessories.png" /></td>
		<td>&nbsp;Women</td></tr></table></a></li>

		<li><a href="#sou"><table><tr><td><img src="res/icons/children.png" style = "height: 25px; width: 25px" /></td>
		<td>&nbsp;Children</td></tr></table></a></li>		
...
<div id="navbar">
	<ul>
		<li><a class="active" href="got.php">CLOTHING</a></li>
		<li><a href="hp.php">FOOTWEAR</a></li>
		<li><a href="hg.php">ACCESSORIES</a></li>		
	</ul>
</div>
...
if(isset($_SESSION["cart_products"]) && count($_SESSION["cart_products"])>0)
{
	...
	foreach ($_SESSION["cart_products"] as $cart_itm)
	{
		...
		echo '</tr>';
		$subtotal = ((int)$product_price * (int)$product_qty);
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='MEN' AND fandom='Clothing' ORDER BY product_code ASC");
if($results){ 
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='Women' AND fandom='Clothing' ORDER BY product_code ASC");
if($results){ 
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='Children' AND fandom='Clothing' ORDER BY product_code ASC");
if($results){ 
$products_item = '<ul style="list-style-type: none;">';
//$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='CHILDREN' AND fandom='CLOTHING' ORDER BY product_code ASC");
//if($results){ 
...
<footer class="container">
	<div class="row">	
		<p class="col-sm-6">
			&copy; Made with<i style="color: #fd4b4b;">&nbsp; &#9829; &nbsp;</i>in VIT
		</p>
