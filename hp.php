...
<head>
	...
	<link rel="icon" href="res/unified.jpg" sizes="16x16">
...
<div id="navbar">
	<ul>
		<li><a href="got.php">CLOTHING</a></li>
		<li><a class="active" href="hp.php">FOOTWEAR</a></li>
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='MEN' AND fandom='FOOTWEAR' ORDER BY product_code ASC");
if($results){ 
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='Women' AND fandom='FOOTWEAR' ORDER BY product_code ASC");
if($results){ 
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='Children' AND fandom='FOOTWEAR' ORDER BY product_code ASC");
