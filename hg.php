...
<div id="navbar">
	<ul>
		...
		<li><a class="active" href="carthg.php">ACCESSORIES</a></li>
	</ul>
</div>
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='MEN' AND fandom='ACCESSORIES' ORDER BY product_code ASC");
if($results){ 
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='WOMEN' AND fandom='ACCESSORIES' ORDER BY product_code ASC");
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='CHILDREN' AND fandom='ACCESSORIES' ORDER BY product_code ASC");
if($results){ 
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
